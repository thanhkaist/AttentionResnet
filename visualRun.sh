...
python visualize.py --model cbam_resnet50 --attention joint
python visualize.py --model cbam_resnet50 --attention spatial
python visualize.py --model cbam_resnet50 --attention channel
...
python visualize.py --model cbam_resnet34 --attention joint
python visualize.py --model cbam_resnet34 --attention spatial
python visualize.py --model cbam_resnet34 --attention channel
